import { BsFacebook, BsInstagram, BsPinterest, BsTwitter } from 'react-icons/all'
    ...
    >
      <div className="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white">
        ...
        <div>
          ...
          <div className="text-sm mb-4">hello@skillex.com</div>
          <div className="text-sm">+86-158-505-929</div>
